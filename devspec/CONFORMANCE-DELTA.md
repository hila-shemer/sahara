...
- **Event visibility at the first boundary with cycle ≥ C**: INPUT-21 and
  ...
  record ordering it implies. N/A for the timer: type 5 has no EVENTs
  at all (TMR-20 is the *absence* obligation).
